...
export class HeroesService {
  ...
  //Método para obtener los heroes (publico para que salga del servicio)
  getHeroes() {
    return this.heroes;
  }
...
//Esta interface es un template de las caracteristicas de un heroe
